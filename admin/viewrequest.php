...
if (isset($_GET['inid'])) {
    $id = $_GET['inid'];
    $state = 0;
    $sql = 'update request set state=:state  WHERE id=:id';
...
if ($query->rowCount() > 0) {
    foreach ($results as $result) {               ?>
                 <tr>
                     ...
                     <td><?php echo htmlentities($result->branchid); ?></td>
                     ...
                     <td>
                         ...
                         <a href="viewrequest.php?inid=<?php echo htmlentities($result->id); ?>"
                             ...
                             <a href="viewrequest.php?id=<?php echo htmlentities($result->id); ?>"
                                 onclick="return confirm('Are you sure you want to accept this employee?');""><button type="
